...
namespace AI_Assistant
{
    public static class SystemMessagesConstants
    {
        ...
        public const string prefix = @"You are a helpful assistant. response to user request as best as you can as simple html.
        ...
        public const string ImageSystemMessage = $"{prefix}. Please explain the attached image, ** IMPORTANT** :If the image has question or code challanges then please also provide a fully solution, fully implemented source code.";
    }
}